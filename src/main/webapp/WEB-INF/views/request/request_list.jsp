    ...
    <body id="page-top" >
      ...
      <div class="modal-container" id="view-detail">
          ...
          <div class="modal-ftr">
              ...
              <div class="btn-icon"><i class="far fa-heart"></i></div>
          </div>
      </div>
      <!-- 응답하기 -->
      <div class="modal-container" id="view-responseForm">
              ...
              <div class="content-info" style="text-align:center;">
                ...
                <div class="div-inline">
                  <div class="response-info ">
                    <div class="info-title">이름<span style="color:white;">이름</span></div><input class="info-text" name="response-name" type="text" placeholder="이름 입력"></input>
                  </div>
                  <div class="response-info">
                    <div class="info-title">소속단체</div><input class="info-text" name="response-org" type="text" placeholder="소속단체 입력"></input>
                  </div>
                </div>
                <div class="response-info">
                  <div class="info-title">전화번호</div><input class="info-text" name="response-phone" type="text" placeholder="전화번호 입력"></input>
                </div>
                <!-- 공간 맞추기 여백 -->
                <div class="response-info" style="visibility:hidden!important;">
                  <div class="info-title">전화번호</div><input class="info-text" type="text" placeholder="전화번호 입력"></input>
                </div>
                <br>
                  ...
                  <div class="content-needs">
                      <table class="info-table">
                          ...
                          <tr class="needs-category">
                              ...
                              <td>
                                <div>
                                  <i class="fas fa-minus minus-icon" onclick="alert('minus');"></i><input type="text" class="response-item-count" name="response-item" placeholder="0" readonly>
                                  <i class="fas fa-plus plus-icon" onclick="alert('plus');"></i>
                                </div>
                              </td>
                              <td>10 / 30</td>
                          ...
                          <tr>
                              ...
                              <td>
                                <div>
                                  <i class="fas fa-minus minus-icon"></i><input type="text" class="response-item-count" name="response-item" placeholder="0" readonly>
          ...
          <div class="modal-ftr" style="justify-content: space-between;">
            ...
            <div class="btn-back" onclick="goBack()"><span style="color:#e5e5e5; visibility:hidden;">뒤</span>뒤로<span style="color:#e5e5e5; visibility:hidden;">뒤</span></div>
          </div>
      </div>
      ...
      <div id="Wrapper">
        ...
        <section class="page-section-map text-center " id="portfolio">
          <div class="container ">
            ...
            <img class="text-center main-map" src="https://docs.microsoft.com/ko-kr/azure/azure-maps/media/migrate-google-maps-web-app/google-maps-marker.png">
            <div class="container ">
            <div class="map-content test">
              ...
              <div class="map-mid ">
                <p class="wrapper-status">상태 <span class="help-status">응답 대기중</span></p>
                <p>기간 <span class="help-term">보통(한 달 이내)</span></p>
              </div>
              <div class="map-mid ">
                <p class="wrapper-status">주소 <span class="help-status">포항시 북구 흥해읍</span></p>
                <p>문의 <span class="help-term">010-1234-5678</span></p>
              </div>
              <div class="map-right ">
                <span class="help-code">검색코드<input type="text" class="help-code-box"></input><i class="fa fa-clone copy-btn" aria-hidden="true"></i></span>
                <input type="button" class="help-detail" value="자세히 보기"></input>
              </div>
            </div>
          </div>
        </section>
        ...
        <section class="mypage-section2" id="about" style="text-align:center;">
          <form class="search-div">
            <span class="search-text ">검색코드<input type="text" name="code" class="search-box-mid"></input></span>

            <span class="search-text">재화종류<select name="search-type" class="search-box-small">
            ...
            <span class="search-text">주소<input type="text" class="search-box-big"></input>
            </span>
