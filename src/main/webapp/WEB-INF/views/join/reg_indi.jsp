							...
							<div style="text-align: left;">
								<form method="post" name="regForm" action="">
									...
									<div class="input-content">
										...
										<input class="text-input" type="password" name="userpw" id="userpw" placeholder="비밀번호 입력">
										<span class="extra-info" style="color: #e95378">문자, 특수문자를 조합하여 사용하세요.</span>
									</div>
									<div class="input-content">
										<span class="input-title">비밀번호 확인</span><span>&nbsp;<em>*</em></span><br>
										<input class="text-input" type="password" name="userpwchk" id="userpwchk" placeholder="비밀번호 입력">
									</div>
									...
									<div class="input-content">
										...
										<input class="text-input" type="email" name="usermail" id="useremail" placeholder="이메일주소 입력"> <span class="extra-info">주변 이웃들의 필요를 메일로 받으실 수 있습니다. <br>메일 수신
											동의&nbsp;&nbsp; <span> <label><input type="radio" name="mail_rcv" value="1" id="mail_rcv" checked> 예</label>&nbsp;&nbsp; <label><input type="radio" name="mail_rcv"
													value="0" id="mail_rcv"> 아니요</label>
										</span></span>
									</div>
									<div class="input-content">
