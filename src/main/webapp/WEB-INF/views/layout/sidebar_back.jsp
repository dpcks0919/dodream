    ...
    pageEncoding="UTF-8"%>
      ...
      <div id="mySidebar2" class="sidebar2">
        <h1 style="font-size:8rem!important; position:relative; left:50%; transform: translateX(-50%);"><i class="fa fa-user" aria-hidden="true"></i></h2>
          ...
          <br>
          <span class="login">
          <a style="font-size:1rem!important; display:inline;  position:relative; padding:0; padding-right:3vh; border-right:1px solid white;"><span style="visibility:hidden; ">로</span>로그인</a>
          <a style="font-size:1rem!important; display:inline;  position:relative; padding:0;padding-left:3vh;">회원가입</a>
          </span>
